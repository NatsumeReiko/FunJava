...
public class VolatileLab extends AppCompatActivity {
    ...
    private Runnable makeReadVolatileCountRunnable() {
        return new Runnable() {
            ...
            public void run() {
                ...
                for (int index = 0; index < MAX_INDEX; index++) {
                    Log.d(TAG, "R volatileCount = " + volatileCount);
                    sleepThread();
                }
            }
        };
...
//    }
    ...
    private void printOutR() {
        Log.d(TAG, " countN = " + count + " volatileCount = " + volatileCount);
    }
